from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget, QLineEdit, QGridLayout, QBoxLayout, QHBoxLayout, QVBoxLayout, QPushButton, QFrame,QLabel, QSizePolicy
...
""")
      ...
      def load_icon(self,path,width=60,height=60):
          pixmap = QPixmap(path)
          if pixmap.isNull():
                 print(f"[❗ Warning] QPixmap is null. Image not found at: {path}")
          else:
...
class InitialScreen(QWidget):
     ...
     def __init__(self, parent = None):
          ...
          # max_gif_size_H = int(screen_width / 10*4)
          
          # movie.setScaledSize(QSize(screen_width, max_gif_size_H))
           movie.setScaledSize(QSize(700,700))
